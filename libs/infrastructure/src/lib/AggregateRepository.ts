import {setMessageMetadata} from "@app/messaging/message";
import {Event, EventVisibility, providesPublicEvent} from "@app/messaging/event";
...
import {MatchOperator, MetadataMatcher} from "@app/infrastructure/EventStore";
